...
//#node5:posx=-578.5:posy=-140:title=Texture:title2=MainTexture:input0=(0,0):input0type=Vector2:
...
//#masterNode:posx=0:posy=0:title=Master Node:input0linkindexnode=5:input0linkindexoutput=0:input2linkindexnode=12:input2linkindexoutput=0:input3linkindexnode=10:input3linkindexoutput=0:input5linkindexnode=8:input5linkindexoutput=0:
//#sm=3.0
//#blending=Normal
//#ShaderName
Shader "Custom/ShaderFusion/diffuse_bump_spec_gloss_1.1" {
	Properties {
