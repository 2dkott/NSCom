...
public class DecalPolygonLegacy {
	
	public List<Vector3> vertices = new List<Vector3>(9);

	public DecalPolygonLegacy(params Vector3[] vts) {
		vertices.AddRange( vts );
	}

	public static DecalPolygonLegacy ClipPolygon (DecalPolygonLegacy polygon, Plane plane) {
		...
		DecalPolygonLegacy tempPolygon = new DecalPolygonLegacy();
